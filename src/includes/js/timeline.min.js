...
!function(t) {
    Timeline = {
        ...
        change_slide: function(t, e) {
            var i = this;
            t || (t = "load"),
            "click" === t ? (i.options.startItem = e,
            i.autoplay_init()) : i.get_count() - 1 > i.get_current() && 0 === i.initials.direction ? i.options.startItem = i.get_next() : i.get_current() > 0 && 1 === i.initials.direction ? i.options.startItem = i.get_next() : i.autoplay_clear(),
            i.change_timeline()
        },
        move_slide: function(e) {
            var i, s, a = this, o = t(a.wrapClass + " .timeline-list-wrap"), n = t(a.wrapClass + " ." + a.options.itemClass);
            "vertical" === e ? (i = t(a.wrapClass + " .timeline-list").height(),
            s = n.outerHeight() * a.get_count(),
            o.height(s)) : (i = t(a.wrapClass + " .timeline-list").width(),
        ...
        move_dots: function(e) {
            var i, s, a = this, o = t(a.wrapClass + " .timeline-list"), n = t(a.wrapClass + " .timeline-dots li"), l = t(a.wrapClass + " .timeline-dots");
            "vertical" === e ? (i = n.outerHeight(!0),
            s = o.height()) : (i = n.outerWidth(!0),
            s = o.width());
            var r = -(i * a.get_current()) - -s / 2
              , p = i * a.get_count();
            "vertical" === e ? (l.height(p),
            l.css({
        ...
        build_dots: function() {
            var e, s, a = this;
            for (e = t("<ul />").addClass("timeline-dots"),
            i = 0; i <= a.get_count() - 1; i += 1)
                s = t(a.wrapClass + " ." + a.options.itemClass).eq(i).data("time"),
